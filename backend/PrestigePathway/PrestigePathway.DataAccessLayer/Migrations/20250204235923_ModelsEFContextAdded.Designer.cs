...
namespace PrestigePathway.DataAccessLayer.Migrations
{
    ...
    [Migration("20250204235923_ModelsEFContextAdded")]
    partial class ModelsEFContextAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrestigePathway.DataAccessLayer.NewFolder.StaffAssistant", b =>
                {
                    ...
                    b.Property<int>("StaffAssistantID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StaffAssistantID"));
